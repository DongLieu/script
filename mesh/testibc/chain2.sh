...
meshd add-genesis-account val 1000000000000stake --keyring-backend test --home=$home 
meshd add-genesis-account test1 1000000000stake --keyring-backend test --home=$home

# Sign genesis transaction
meshd gentx val 1000000stake --keyring-backend test --chain-id $chainid --home=$home
