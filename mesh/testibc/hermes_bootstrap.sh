...
hermes keys add --chain chain-1 --key-name "decentrio-main1" --mnemonic-file $HOME/.hermes/mnemonic1 --overwrite
hermes keys add --chain chain-2 --key-name "decentrio-main2" --mnemonic-file $HOME/.hermes/mnemonic2 --overwrite
