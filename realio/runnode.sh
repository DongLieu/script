...
echo $(cat ./typeskey/mnemonic1)| realio-networkd keys add val1 --keyring-backend test --recover
echo $(cat ./typeskey/mnemonic2)| realio-networkd keys add val2 --keyring-backend test  --recover
