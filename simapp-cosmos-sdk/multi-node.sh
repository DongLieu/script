...
simd genesis add-genesis-account $(simd keys show validator1 -a --keyring-backend=test --home=$HOME/.simd/validator1) 10000000000000000000000000000000stake,10000000000000000000000000000000sim --home=$HOME/.simd/validator1 
simd genesis add-genesis-account $(simd keys show validator2 -a --keyring-backend=test --home=$HOME/.simd/validator2) 10000000000000000000000000000000stake,10000000000000000000000000000000sim --home=$HOME/.simd/validator1 
simd genesis add-genesis-account $(simd keys show validator3 -a --keyring-backend=test --home=$HOME/.simd/validator3) 10000000000000000000000000000000stake,10000000000000000000000000000000sim --home=$HOME/.simd/validator1
simd genesis add-genesis-account $(simd keys show validator1 -a --keyring-backend=test --home=$HOME/.simd/validator1) 10000000000000000000000000000000stake,10000000000000000000000000000000sim --home=$HOME/.simd/validator2
simd genesis add-genesis-account $(simd keys show validator2 -a --keyring-backend=test --home=$HOME/.simd/validator2) 10000000000000000000000000000000stake,10000000000000000000000000000000sim --home=$HOME/.simd/validator2 
simd genesis add-genesis-account $(simd keys show validator3 -a --keyring-backend=test --home=$HOME/.simd/validator3) 10000000000000000000000000000000stake,10000000000000000000000000000000sim --home=$HOME/.simd/validator2 
simd genesis add-genesis-account $(simd keys show validator1 -a --keyring-backend=test --home=$HOME/.simd/validator1) 10000000000000000000000000000000stake,10000000000000000000000000000000sim --home=$HOME/.simd/validator3 
simd genesis add-genesis-account $(simd keys show validator2 -a --keyring-backend=test --home=$HOME/.simd/validator2) 10000000000000000000000000000000stake,10000000000000000000000000000000sim --home=$HOME/.simd/validator3 
simd genesis add-genesis-account $(simd keys show validator3 -a --keyring-backend=test --home=$HOME/.simd/validator3) 10000000000000000000000000000000stake,10000000000000000000000000000000sim --home=$HOME/.simd/validator3
