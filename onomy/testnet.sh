...
sleep 7
# killall onomyd || true
echo $mnemonic4 | onomyd keys add test --recover --keyring-backend=test --home=$HOME/.onomyd/validator1
onomyd tx bank send onomy1wa3u4knw74r598quvzydvca42qsmk6jrc6uj7m onomy1p5jf6pfs6gzhvcspqtjrmecy0vw223m5nrf8n2 100000stake --keyring-backend=test --chain-id=testing-1 -y --home=$HOME/.onomyd/validator1 --fees 10stake
