...
screen -S onomy0 -t onomy0 -d -m onomyd start
...
sleep 7
onomyd tx gov submit-proposal  /Users/donglieu/script/onomy/upgarde-reserve/upgrade2_2_0.json --keyring-backend=test  --home=$HOME/.onomy --from val -y --chain-id onomy-mainnet-1 --fees 20stake

sleep 7
onomyd tx gov vote 34 yes  --from val --keyring-backend test --home ~/.onomy --chain-id onomy-mainnet-1 -y --fees 20stake
