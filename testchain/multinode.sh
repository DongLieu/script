...
# sleep 7
testchaind tx bank send cosmos1wa3u4knw74r598quvzydvca42qsmk6jrzmgy07 cosmos1w7f3xx7e75p4l7qdym5msqem9rd4dyc4752spg 10000000000000000000000stake --keyring-backend=test --chain-id=testing-1 -y --home=$HOME/.testchaind/validator1 --fees 200000stake
# sleep 7
...
testchaind in-place-testnet testing-1  cosmosvaloper1wa3u4knw74r598quvzydvca42qsmk6jr80u3rd --accounts-to-fund="cosmos1wa3u4knw74r598quvzydvca42qsmk6jrzmgy07,cosmos1w7f3xx7e75p4l7qdym5msqem9rd4dyc4752spg" --home=$HOME/.testchaind/validator1 --skip-confirmation