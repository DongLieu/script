...
xiond keys add validator1 --keyring-backend=test --home=$HOME/.xiond/validator1
xiond keys add validator2 --keyring-backend=test --home=$HOME/.xiond/validator2
xiond keys add validator3 --keyring-backend=test --home=$HOME/.xiond/validator3
...
sed -i -E "s|persistent_peers = \"\"|persistent_peers = \"$node1@localhost:26656,$node2@localhost:26656,$node3@localhost:26656\"|g" $HOME/.xiond/validator1/config/config.toml
sed -i -E "s|persistent_peers = \"\"|persistent_peers = \"$node1@localhost:26656,$node2@localhost:26656,$node3@localhost:26656\"|g" $HOME/.xiond/validator2/config/config.toml
sed -i -E "s|persistent_peers = \"\"|persistent_peers = \"$node1@localhost:26656,$node2@localhost:26656,$node3@localhost:26656\"|g" $HOME/.xiond/validator3/config/config.toml
...
# xiond tx bank send $(xiond keys show validator1 -a --keyring-backend=test --home=$HOME/.xiond/validator1) $(xiond keys show validator2 -a --keyring-backend=test --home=$HOME/.xiond/validator2) 100000stake --keyring-backend=test --chain-id=testing-1 -y --home=$HOME/.xiond/validator1 --fees 100000000000000xion
