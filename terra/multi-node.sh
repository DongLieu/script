...
terrad tx bank send $(terrad keys show validator1 -a --keyring-backend=test --home=$HOME/.terrad/validator1) $(terrad keys show validator2 -a --keyring-backend=test --home=$HOME/.terrad/validator2) 1000000uluna --home=$HOME/.terrad/validator1 --keyring-backend=test -y --gas auto --gas-adjustment 3 --gas-prices 10uluna