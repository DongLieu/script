...
rm -rf ~/.gaiad/validator4

# node 4
mkdir $HOME/.gaiad/validator4

gaiad init validator4 --chain-id testing-1 --home=$HOME/.gaiad/validator4

# gaiad keys add validator4 --keyring-backend=test --home=$HOME/.gaiad/validator4
echo $(cat /Users/donglieu/script/keys/mnemonic4)| gaiad keys add validator4 --recover --keyring-backend=test --home=$HOME/.gaiad/validator4
# cosmos1qvuhm5m644660nd8377d6l7yz9e9hhm9evmx3x

VALIDATOR4_APP_TOML=$HOME/.gaiad/validator4/config/app.toml
...
VALIDATOR4_CONFIG=$HOME/.gaiad/validator4/config/config.toml
...
cp $HOME/.gaiad/validator1/config/genesis.json $HOME/.gaiad/validator4/config/genesis.json
...
sed -i -E "s|persistent_peers = \"\"|persistent_peers = \"$node1@localhost:26656,$node2@localhost:26653,$node3@localhost:26650\"|g" $HOME/.gaiad/validator4/config/config.toml

# gaiad keys show validator4 -a --keyring-backend=test --home=$HOME/.gaiad/validator4

screen -S gaia4 -t gaia4 -d -m gaiad start --home=$HOME/.gaiad/validator4

sleep 7

json_string=$(gaiad tendermint show-validator --home=$HOME/.gaiad/validator4)
...
gaiad tx staking create-validator /Users/donglieu/script/gaia/validator4.json --chain-id=testing-1 --from=cosmos1qvuhm5m644660nd8377d6l7yz9e9hhm9evmx3x --gas=500000 --keyring-backend=test --home=$HOME/.gaiad/validator4 -y --fees 500000stake
...
#   --pubkey=$(gaiad tendermint show-validator --home=$HOME/.gaiad/validator4) \
#   --moniker=MONIKER-YAZ \
#   --chain-id=testing-1 \
